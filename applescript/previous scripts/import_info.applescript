global target_file
set target_file to "Macintosh HD:Users:litong30:research:Trento:Workspace:TLSRAF:applescript:graph_info.txt"
global element_info
...
--set target_file to POSIX path of ((path to me as text) & "::") & "applescript/graph_info.txt" --- get current directory
--set target_file to POSIX file target_file --- change it into HFS format
--return target_file as string
--set target_file to "Macintosh HD:Users:litong30:research:Trento:Workspace:TLSRAF:applescript:graph_info.txt"
