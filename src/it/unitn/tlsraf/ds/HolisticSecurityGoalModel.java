	...
	public String generateFormalExpression() {
		...
		for (Element e : this.elements) {
			...
			if (re.refine_links.size() > 0) {
				if (re.refine_links.size() == 1) {
					result += "refine_1(" + re.refine_links.get(0).getSource().getId() + "," + re.getId() + ").\n";
				} else if (re.refine_links.size() == 2) {
					result += "refine_2(" + re.refine_links.get(0).getSource().getId() + "," + re.refine_links.get(1).getSource().getId() + ","
							+ re.getId() + ").\n";
				} else if (re.refine_links.size() == 3) {
					result += "refine_3(" + re.refine_links.get(0).getSource().getId() + "," + re.refine_links.get(1).getSource().getId() + ","
							+ re.refine_links.get(2).getSource().getId() + "," + re.getId() + ").\n";
				} else if (re.refine_links.size() == 4) {
					result += "refine_4(" + re.refine_links.get(0).getSource().getId() + "," + re.refine_links.get(1).getSource().getId() + ","
							+ re.refine_links.get(2).getSource().getId() + "," + re.refine_links.get(3).getSource().getId() + "," + re.getId()+ ").\n";
				} else if (re.refine_links.size() == 5) {
					result += "refine_5(" + re.refine_links.get(0).getSource().getId() + "," + re.refine_links.get(1).getSource().getId() + ","
							+ re.refine_links.get(2).getSource().getId() + "," + re.refine_links.get(3).getSource().getId() + ","
							+ re.refine_links.get(4).getSource().getId() + "," + re.getId() + ").\n";
				}
			}
